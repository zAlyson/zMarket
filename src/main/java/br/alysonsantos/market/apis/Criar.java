...
public class Criar {
	...
	public static ItemStack addhead(String nome , String[] lore, String url)
	  {
	...
	public static ItemStack addverde(String nome, String[] lore) {
	...
	@SuppressWarnings("deprecation")
	public static ItemStack addcinza(String nome, String[] lore) {
	...
	public static ItemStack add(String nome, String nomehead, String dono, String[] lore) {
		ItemStack item = new ItemStack(Material.SKULL_ITEM, 1);
		item.setDurability((short) 3);
		SkullMeta skull = (SkullMeta) item.getItemMeta();
		skull.setOwner(dono);
		skull.setLore(Arrays.asList(lore));
		skull.setDisplayName(nomehead);
	...
	public static ItemStack add(Material m, int amount, String nome, String[] lore) {
